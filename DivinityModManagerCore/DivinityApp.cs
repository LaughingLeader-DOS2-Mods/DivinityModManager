...
namespace DivinityModManager
{
	public static class DivinityApp
	{
		...
		public static DivinityModData MOD_Shared { get; private set; } = new DivinityModData { Name = "Shared", UUID = "2bd9bdbe-22ae-4aa2-9c93-205880fc6564", Folder = "Shared", Version = DivinityModVersion.FromInt(389028377), Type = "Adventure", Targets = "Story", Author = "Larian Studios", Description = "", MD5 = "", IsLarianMod = true, IsHidden = true };
		public static DivinityModData MOD_Shared_DOS { get; private set; } = new DivinityModData { Name = "Shared_DOS", UUID = "eedf7638-36ff-4f26-a50a-076b87d53ba0", Folder = "Shared_DOS", Version = DivinityModVersion.FromInt(268435456), Type = "Adventure", Targets = "Story", Author = "Larian Studios", Description = "", MD5 = "", IsLarianMod = true, IsHidden = true };

...
namespace DivinityModManager
{
	public static class DivinityApp
	{
		...
		public static DivinityModData MOD_Origins { get; private set; } = new DivinityModData { Name = "Divinity: Original Sin 2", UUID = "1301db3d-1f54-4e98-9be5-5094030916e4", Folder = "DivinityOrigins_1301db3d-1f54-4e98-9be5-5094030916e4", Version = DivinityModVersion.FromInt(372645092), Type = "Adventure", Targets = "Story", Author = "Larian", Description = "", MD5 = "", IsLarianMod = true};
		public static DivinityModData MOD_Shared { get; private set; } = new DivinityModData { Name = "Shared", UUID = "2bd9bdbe-22ae-4aa2-9c93-205880fc6564", Folder = "Shared", Version = DivinityModVersion.FromInt(389028377), Type = "Adventure", Targets = "Story", Author = "Larian", Description = "", MD5 = "", IsLarianMod = true, IsHidden = true };
		public static DivinityModData MOD_Shared_DOS { get; private set; } = new DivinityModData { Name = "Shared_DOS", UUID = "eedf7638-36ff-4f26-a50a-076b87d53ba0", Folder = "Shared_DOS", Version = DivinityModVersion.FromInt(268435456), Type = "Adventure", Targets = "Story", Author = "Larian", Description = "", MD5 = "", IsLarianMod = true, IsHidden = true };
		public static DivinityModData MOD_Character_Creation_Pack { get; private set; } = new DivinityModData { Name = "Character_Creation_Pack", UUID = "b40e443e-badd-4727-82b3-f88a170c4db7", Folder = "Character_Creation_Pack", Version = DivinityModVersion.FromInt(268435456), Type = "Add-on", Targets = "Story", Author = "Larian", Description = "", MD5 = "" , IsLarianMod = true};
		public static DivinityModData MOD_GameMaster { get; private set; } = new DivinityModData { Name = "Game Master", UUID = "00550ab2-ac92-410c-8d94-742f7629de0e", Folder = "GameMaster", Version = DivinityModVersion.FromInt(271587865), Type = "Adventure", Targets = "Story", Author = "Larian", Description = "", MD5 = "a81ffa30bfb55ccddbdc37256bc6f7f4" , IsLarianMod = true};
		public static DivinityModData MOD_Arena { get; private set; } = new DivinityModData { Name = "Arena", UUID = "a99afe76-e1b0-43a1-98c2-0fd1448c223b", Folder = "DOS2_Arena", Version = DivinityModVersion.FromInt(271981796), Type = "Adventure", Targets = "Story", Author = "Larian", Description = "", MD5 = "ba12b04eb34b2bcac60bb3edcceb7c5e" , IsLarianMod = true};
		...
		public static List<DivinityModData> MODS_GiftBag { get; private set; } = new List<DivinityModData>()
		{
			...
			new DivinityModData{ Name = "Source Meditation", UUID = "1273be96-6a1b-4da9-b377-249b98dc4b7e", Folder="AS_RestRestorePoints", Version=DivinityModVersion.FromInt(268435456), Type="Add-on", Targets="Story", Author="Larian", Description="Restores Source Points whenever a player character rests.", MD5="", IsLarianMod = true},
			new DivinityModData{ Name = "From the Ashes", UUID = "af4b3f9c-c5cb-438d-91ae-08c5804c1983", Folder="AS_Resturrect", Version=DivinityModVersion.FromInt(268435456), Type="Add-on", Targets="Story", Author="Larian", Description="Never underestimate the power of a good sleep! Simply use the bedroll at any non-combat time to resurrect your dead allies.", MD5="", IsLarianMod = true},
			...
			new DivinityModData{ Name = "8 Action Points", UUID = "9b45f7e5-d4e2-4fc2-8ef7-3b8e90a5256c", Folder="CMP_8AP_Kamil", Version=DivinityModVersion.FromInt(268435456), Type="Add-on", Targets="Story", Author="Larian", Description="Increases the base maximum Action Points of hero characters to 8.", MD5="", IsLarianMod = true},
			new DivinityModData{ Name = "Hagglers", UUID = "f33ded5d-23ab-4f0c-b71e-1aff68eee2cd", Folder="CMP_BarterTweaks", Version=DivinityModVersion.FromInt(268435456), Type="Add-on", Targets="Story", Author="Larian", Description="Let the reputation and skill of your whole party help when you want to haggle for the best prices!", MD5="", IsLarianMod = true},
